...
const SERVICES_FALLBACK = [
  ...
  { id: '2', name: 'Fence & Landscaping',    description: 'Decks, pergolas, fences, and outdoor living spaces built to last.',                  cover_image_url: '/photos/fence-and-landscaping.jpg' },
