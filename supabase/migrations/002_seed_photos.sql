...
UPDATE service_categories SET cover_image_url = '/photos/fence-and-landscaping.jpg'  WHERE name = 'Deck & Outdoor Structures';
...
INSERT INTO portfolio_photos (image_url, category_id, caption) VALUES
  ...
  ('/photos/fence-and-landscaping.jpg',        (SELECT id FROM service_categories WHERE name = 'Deck & Outdoor Structures'),   'Fence and landscaping'),
